...
namespace Web.Core.API.Middlewares.Interceptors;
public class SignalRAfterResponseMiddleware
{
    ...
    {
        "/ProcessMedicalRecords/CreateAttention",
        "/ProcessMedicalRecords/AssignAttention",
        "/ProcessMedicalRecords/InProcessAttention",
        "/ProcessMedicalRecords/FinishAttention",
        "/ProcessMedicalRecords/CancelAttentions",
        "/AuthomatedAttentions/CreateAttentions",
        "/AuthomatedAttentions/AssignAttentions",
        "/AuthomatedAttentions/InProcessAttentions",
        "/AuthomatedAttentions/FinishAttentions",
        "/AuthomatedAttentions/CancelAttentions"
    };
