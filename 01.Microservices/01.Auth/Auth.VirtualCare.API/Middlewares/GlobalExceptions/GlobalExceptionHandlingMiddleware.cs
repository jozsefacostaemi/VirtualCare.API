...
namespace Auth.VirtualCare.API.Middlewares.GlobalExceptions
{
    public class GlobalExceptionHandlingMiddleware : IMiddleware
    {
        ...
        private Task sendMessageBrokers(RequestResult response)
        {
        ...
        private RequestResult BuildErrorResponse(string module, ProblemDetails problemDetails, string messsage) => new RequestResult(problemDetails, false, messsage, module);
