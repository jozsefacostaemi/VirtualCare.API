...
using Auth.VirtualCare.Application.Common.Behaviors;
using Auth.VirtualCare.Application.Common.Decorators;
...
namespace Auth.VirtualCare.Application
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddAplicationAuth(this IServiceCollection services)
        {
        ...
        {
            services.AddLocalization(options => options.ResourcesPath = "../Auth.VirtualCare.Domain/Resources");
